  ...
  <div class="profiletimeline position-relative">
      ...
      <div class="sl-right">
        <div>
          <div class="d-md-flex align-items-center">
            <h3 class="text-h6">Джон Доу</h3>
            <div class="sl-date text-muted ms-1">5 минут назад</div>
          </div>
    ...
    <div class="sl-item my-4 border-top pt-4">
      ...
      <div class="sl-right">
        <div>
          <div class="d-md-flex align-items-center">
            <h3 class="text-h6">Джеймс Смит</h3>
            <div class="sl-date text-muted ms-1">5 минут назад</div>
          </div>
    ...
    <div class="sl-item my-4 border-top pt-4">
      ...
      <div class="sl-right">
        <div>
          <div class="d-md-flex align-items-center">
            <h3 class="text-h6">Мария Смит</h3>
            <div class="sl-date text-muted ms-1">5 минут назад</div>
          </div>
          <p class="my-4 fs-3">
